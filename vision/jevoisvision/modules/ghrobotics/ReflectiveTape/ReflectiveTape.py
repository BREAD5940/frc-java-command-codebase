...
class ReflectiveTape:
    ...
    def process(self, inframe, outframe):
        ...
        outframe.sendCv(inframe.getCvBGR())
...
class GripPipeline:
    ...
    def __init__(self):
        ...
        """
        self.__hsl_threshold_hue = [60.0,95.0]
        self.__hsl_threshold_saturation = [150.0, 255.0]
        self.__hsl_threshold_luminance = [70.0, 210.0]
