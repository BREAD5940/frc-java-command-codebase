...
public class auto_action_DRIVE extends Command {
   ...
   * @param timeout
   */
  public auto_action_DRIVE(double distance, double targetSpeed, double timeout) {
   ...
   * @param timeout
   */
  public auto_action_DRIVE(double distance, double timeout) {
    this.targetDistance = distance;
    this.timeout = timeout;
    requires(Robot.drivetrain);
  }
   ...
   * @param distance
   */
  public auto_action_DRIVE(double distance) {
    this.targetDistance = distance;
    requires(Robot.drivetrain);
  }
