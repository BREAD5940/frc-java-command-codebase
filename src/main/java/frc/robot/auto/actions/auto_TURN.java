...
public class auto_TURN extends Command {
  ...
  TerriblePID turnPID = new TerriblePID(RobotConfig.auto_turn_kp, RobotConfig.auto_turn_ki, 
    RobotConfig.auto_min_turn_speed, 
    RobotConfig.auto_max_turn_speed, 
    RobotConfig.auto_integral_zone, 
    RobotConfig.auto_max_integral);
   ...
   * @param target_angle
   */
  public auto_TURN(double target_angle) {
   ...
   * @param target_angle
   */
  public auto_TURN(double target_angle, boolean isAbsolute) {
  ...
  protected boolean isFinished() {
    ...
    return ( (Math.abs(Robot.gyro.getRate() ) < RobotConfig.angular_velocity_tolerence)
      && (Math.abs(Robot.gyro.getAngle()) < RobotConfig.auto_angle_tolerence));
