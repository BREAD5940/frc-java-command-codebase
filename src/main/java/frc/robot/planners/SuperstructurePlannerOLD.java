...
//		wristPoint = new Translation2d(LengthKt.getInch(Math.cos(goalState.getElbowAngle().getRadian()) * SuperStructureConstants.Elbow.carriageToIntake.getInch()).getMeter(),
//				carriagePoint.getY() +
//						(LengthKt.getInch(Math.sin(goalState.getAngle().getElbow().angle.getRadian()) * SuperStructureConstants.Elbow.carriageToIntake.getInch())).getMeter());
//
