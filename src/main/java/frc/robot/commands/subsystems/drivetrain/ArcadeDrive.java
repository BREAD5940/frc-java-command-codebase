...
public class ArcadeDrive extends Command {
	...
	protected void initialize() {
		...
		Robot.drivetrain.getRight().getMaster().setOpenLoopRampRate(0.15);
	...
	protected void end() {
		...
		Robot.drivetrain.getLeft().getMaster().setClosedLoopRampRate(0.0);
		Robot.drivetrain.getRight().getMaster().setClosedLoopRampRate(0.0);
		Robot.drivetrain.getLeft().getMaster().setOpenLoopRampRate(0.0);
		Robot.drivetrain.getRight().getMaster().setOpenLoopRampRate(0.0);
	}
