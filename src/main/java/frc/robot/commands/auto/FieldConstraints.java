// Hi, it's Matt again here to ~~ruin your day~~ update falconlib
// It's broken right now because Translation2d no longer abuses typesafe units
...
//						if (distanceFormula(point, new Translation2d(x, y)) < lastShortest) {
//							lastNearest = new Translation2d(x, y);
//						}
//					}
//				}
...
//			double curve = original.get(i).getState().getCurvature();
...
//			Pose2dWithCurvature newCurve = new Pose2dWithCurvature(curve, original.get(i).getState().getDkds());
...
//	}
//
//	// Matt was here, and wants you to know that it's now in meters, as Translation2d is big oof. You're welcome?
//	public static double distanceFormula(Translation2d p1, Translation2d p2) {
//		return Math.sqrt(Math.abs(Math.pow(p1.getX() - p2.getX(), 2) + Math.pow(p1.getY() - p2.getY(), 2)));
//	}
//}
