...
public class Trajectories {
	...
	private static void genLocs() {
		...
		locations.put("loadingL",
				new Pose2d(LengthKt.getFeet(1.286), LengthKt.getFeet(25.021), Rotation2dKt.getDegree(180.0)));
		locations.put("loadingR",
				new Pose2d(LengthKt.getFeet(1.325), LengthKt.getFeet(2.336), Rotation2dKt.getDegree(180.0)));
		locations.put("cargoL1",
				new Pose2d(LengthKt.getFeet(21.565), LengthKt.getFeet(17.235), Rotation2dKt.getDegree(-90d)));
		locations.put("cargoL2",
				new Pose2d(LengthKt.getFeet(23.532), LengthKt.getFeet(17.235), Rotation2dKt.getDegree(-90d)));
		locations.put("cargoL3",
				new Pose2d(LengthKt.getFeet(25.277), LengthKt.getFeet(17.235), Rotation2dKt.getDegree(-90d)));
		locations.put("cargoML",
				new Pose2d(LengthKt.getFeet(17.101), LengthKt.getFeet(14.338), Rotation2dKt.getDegree(180)));
		locations.put("cargoMR",
				new Pose2d(LengthKt.getFeet(17.066), LengthKt.getFeet(12.653), Rotation2dKt.getDegree(180)));
		locations.put("cargoR1",
				new Pose2d(LengthKt.getFeet(21.565), LengthKt.getFeet(9.898), Rotation2dKt.getDegree(90d)));
		locations.put("cargoR2",
				new Pose2d(LengthKt.getFeet(23.532), LengthKt.getFeet(9.898), Rotation2dKt.getDegree(90d)));
		locations.put("cargoR3",
				new Pose2d(LengthKt.getFeet(25.277), LengthKt.getFeet(9.898), Rotation2dKt.getDegree(90d)));
		locations.put("depotL",
				new Pose2d(LengthKt.getFeet(5.203), LengthKt.getFeet(20.517), Rotation2dKt.getDegree(0)));
		locations.put("depotR",
				new Pose2d(LengthKt.getFeet(5.203), LengthKt.getFeet(6.107), Rotation2dKt.getDegree(0)));
		locations.put("yeetL",
				new Pose2d(LengthKt.getFeet(13.606), LengthKt.getFeet(21.315), Rotation2dKt.getDegree(145)));
		locations.put("yeetR",
				new Pose2d(LengthKt.getFeet(13.606), LengthKt.getFeet(5.685), Rotation2dKt.getDegree(-145)));
		locations.put("pyeetL",
				new Pose2d(LengthKt.getFeet(13.606), LengthKt.getFeet(21.315), Rotation2dKt.getDegree(325)));
		locations.put("pyeetR",
				new Pose2d(LengthKt.getFeet(13.606), LengthKt.getFeet(5.685), Rotation2dKt.getDegree(35)));
	...
	public static List<String> grabs = new ArrayList<String>(
			Arrays.asList("habR", "habM", "habL", "loadingL", "loadingR", "depotLF", "depotLB", "depotRF", "depotRB"));
	public static List<String> puts = new ArrayList<String>(
			Arrays.asList("cargoL1", "cargoL2", "cargoL3", "cargoML", "cargoMR", "cargoR1", "cargoR2", "cargoR3",
	...
	public static List<TimingConstraint<Pose2dWithCurvature>> kLowGearConstraints = Arrays.asList(
			...
			new VelocityLimitRegionConstraint(new Rectangle2d(7.0, 0.0, 8.0, 13.0),
	...
	public static void generateAllTrajectories(boolean isReal) {
		...
		reverse3FeetLowGear = generateTrajectoryLowGear(
				Arrays.asList(new Pose2d(LengthKt.getFeet(0), LengthKt.getFeet(0), Rotation2dKt.getDegree(180)),
						new Pose2d(LengthKt.getFeet(3), LengthKt.getFeet(0), Rotation2dKt.getDegree(180))),
				true);
		...
		generatedHGTrajectories.put("habL to cargoML", generateTrajectoryHighGear(
				new ArrayList<Pose2d>(Arrays.asList(locations.get("habL"), locations.get("cargoML"))), true));
		generatedHGTrajectories.put("habM to cargoMR", generateTrajectoryHighGear(
				new ArrayList<Pose2d>(Arrays.asList(locations.get("habM"), locations.get("cargoMR"))), true));
		generatedHGTrajectories.put("habM to cargoML", generateTrajectoryHighGear(
				new ArrayList<Pose2d>(Arrays.asList(locations.get("habM"), locations.get("cargoML"))), true));
		generatedHGTrajectories.put("habR to cargoMR", generateTrajectoryHighGear(
				new ArrayList<Pose2d>(Arrays.asList(locations.get("habR"), locations.get("cargoMR"))), true));

		generatedHGTrajectories.put("cargoML to loadingL", generateTrajectoryHighGear(
				new ArrayList<Pose2d>(Arrays.asList(locations.get("cargoML"), locations.get("loadingL"))), false));
		generatedHGTrajectories.put("cargoMR to loadingR", generateTrajectoryHighGear(
				new ArrayList<Pose2d>(Arrays.asList(locations.get("cargoMR"), locations.get("loadingR"))), false));

		generatedHGTrajectories.put("cargoL1 to depotL", generateTrajectoryHighGear(
				new ArrayList<Pose2d>(Arrays.asList(locations.get("cargoL1"), locations.get("depotL"))), true));
		generatedHGTrajectories.put("cargoR1 to depotR", generateTrajectoryHighGear(
				new ArrayList<Pose2d>(Arrays.asList(locations.get("cargoR1"), locations.get("depotR"))), true));

		generatedHGTrajectories.put("depotL to cargoL1", generateTrajectoryHighGear(
				new ArrayList<Pose2d>(Arrays.asList(locations.get("depotL"), locations.get("cargoL1"))), false));
		generatedHGTrajectories.put("depotR to cargoR1", generateTrajectoryHighGear(
				new ArrayList<Pose2d>(Arrays.asList(locations.get("depotR"), locations.get("cargoR1"))), false));
		...
		generatedHGTrajectories.put("test",
				generateTrajectory(new ArrayList<Pose2d>(Arrays.asList(locations.get("loadingL"),
						...
						kHighGearConstraints, kDefaultStartVelocity, kDefaultEndVelocity, kDefaultVelocityHigh,
		...
		generatedLGTrajectories.put("test",
				generateTrajectory(new ArrayList<Pose2d>(Arrays.asList(locations.get("loadingL"),
						new Pose2d(LengthKt.getFeet(15.9), LengthKt.getFeet(22.011), Rotation2dKt.getDegree(165)),
						new Pose2d(LengthKt.getFeet(21.646), LengthKt.getFeet(19.223), Rotation2dKt.getDegree(-90)))),
						kLowGearConstraints, kDefaultStartVelocity, kDefaultEndVelocity, kDefaultVelocityLow,
						kDefaultAcceleration, true, kOptomizeSplines));
	 ...
	 * @return
	 */
	public static TimedTrajectory<Pose2dWithCurvature> generateTrajectoryHighGear(List<Pose2d> waypoints,
			boolean reversed) {
		return generateTrajectory(waypoints, kHighGearConstraints, kDefaultStartVelocity, kDefaultEndVelocity,
	...
	* @return
	*/
	public static TimedTrajectory<Pose2dWithCurvature> generateTrajectoryLowGear(List<Pose2d> waypoints,
			boolean reversed) {
		return generateTrajectory(waypoints, kLowGearConstraints, kDefaultStartVelocity, kDefaultEndVelocity,
	...
	public static TimedTrajectory<Pose2dWithCurvature> generateTrajectory(List<Pose2d> waypoints,
			List<? extends TimingConstraint<Pose2dWithCurvature>> constraints_, Velocity<Length> startVelocity,
			Velocity<Length> endVelocity, Velocity<Length> maxVelocity, Acceleration<Length> maxAcceleration,
