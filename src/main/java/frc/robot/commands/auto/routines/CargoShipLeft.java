 ...
 */
public class CargoShipLeft extends VisionCommandGroup {
	...
	public CargoShipLeft(char arg1, char arg2) {
		this();
	}
	 ...
	 */
	public CargoShipLeft(/* char startPos, char side */) {
		...
		var t_farSideRocketL = Trajectories.generateTrajectory(p_toLoadingStationL, Trajectories.kLowGearConstraints, VelocityKt.getVelocity(LengthKt.getFeet(0)),
