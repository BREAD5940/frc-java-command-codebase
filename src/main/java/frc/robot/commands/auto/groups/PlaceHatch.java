...
public class PlaceHatch extends SequentialCommandGroup {
	 ...
	 */
	public PlaceHatch() {
		this.addCommands(new JankyGoToState(fieldPositions.hatchMiddleGoal, iPosition.HATCH));
		this.addCommands(new FollowVisionTargetTheSecond(4.4));
		this.addCommands(new DrivePower(0.4, 0.5));
