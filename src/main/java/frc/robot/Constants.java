...
public class Constants {
	...
	public static final double kVInterceptLeftLow = 0.95 * 1d; // Volts - tuned!
	...
	public static final double kVInterceptRightLow = 30.88 * 1d; // Volts - tuned!
	...
	public static final double kVInterceptLeftHigh = 1.23 * 1d;//4 * 0.4d; // Volts - tuned!
	...
	public static final double kVInterceptRightHigh = 1.21 * 1d;//4 * 0.4d; // Volts - tuned!
