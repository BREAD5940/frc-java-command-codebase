...
public class RobotConfig {
  ...
  public class driveTrain{
    ...
    // Pathfinder shit
    public static final double left_static_kv = 0.1; //TODO TUNE THIS! the throttle required to get the robot moving/overcome static friction
    public static final double right_static_kv = 0.1; //TODO TUNE THIS! the throttle required to get the robot moving/overcome static friction
    ...
    public class right_talons {
      ...
      public static final double velocity_kp_low = left_talons.velocity_kp_low;
      public static final double velocity_ki_low = left_talons.velocity_ki_low;
      public static final double velocity_kd_low = left_talons.velocity_kd_low;
      public static final double velocity_kf_low = left_talons.velocity_kf_low;
      public static final int velocity_izone_low = left_talons.velocity_izone_low;
      public static final double velocity_max_integral_low = 5;
      public static final double position__kp_low = left_talons.position_kp_low;
      public static final double position__ki_low = left_talons.position_ki_low;
      public static final double position__kd_low = left_talons.position_kd_low;
      public static final double position__kf_low = left_talons.position_kf_low;
      // public static final int position_izone_low = 5;
      public static final double position__max_integral_low = 1;
      public static final double velocity_kp_high = left_talons.velocity_kp_high;
      public static final double velocity_ki_high = left_talons.velocity_ki_high;
      public static final double velocity_kd_high = left_talons.velocity_kd_high;
      public static final double velocity_kf_high = left_talons.velocity_kf_high;
      public static final int velocity_izone_high = left_talons.velocity_izone_high;
      public static final double velocity_max_integral_high = 5;
      public static final double position__kp_high = left_talons.position_kp_high;
      public static final double position__ki_high = left_talons.position_ki_high;
      public static final double position__kd_high = left_talons.position_kd_high;
      public static final double position__kf_high = left_talons.position_kf_high;
  ...
  public class elevator {
   public static final double elevator_effective_diameter = 1.27 * 1.6; // TODO fix elevator_effective_diameter!!!! (units must be inches)
    ...
    public class elevator_presets { // various preset elevator max heights
