...
public class RamseteFollower {
    ...
    public DriveSignal getNextDriveSignal(){
        ...
        left = (-(velocity.getAngular() * RobotConfig.driveTrain.drivetrain_width ) + (2 * velocity.getLinear())) / 2;
        right = ((velocity.getAngular() * RobotConfig.driveTrain.drivetrain_width ) + (2 * velocity.getLinear())) / 2;
