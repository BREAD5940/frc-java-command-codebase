...
public class SuperStructure extends HalfBakedSubsystem implements Loggable {
	...
	public SuperstructureMotion planner = SuperstructureMotion.getInstance();
	...
	public static class iPosition {
		...
		public static final SuperStructureState HATCH_GRAB_INSIDE = new SuperStructureState(new ElevatorState(LengthKt.getInch(17.5)),
				new IntakeAngle(new RotatingArmState(RoundRotation2d.getDegree(-58)), new RotatingArmState(RoundRotation2d.getDegree(39))));
...
//	 *
//	 * @param mRequState_ the state that we want the superstructure to end up in
//	 *
//	 * @returnW
